...
function setupPage() {
   ...
   // <%#= image_tag("OLN_3FM.png") %>
   // <!--$('#imageContainer').append('<img src="' + staticImg -->
   console.log("<%= image_url(\"OLN_3FM.png\") %>");
   // <!--                           +'" class="img-rounded center-block img-responsive" alt="bathroom" width="460" height="345">')-->
   $('#imageContainer').append('<img src="' + staticImg + '" class="img-rounded center-block img-responsive" alt="bathroom" width="460" height="345">');                         
